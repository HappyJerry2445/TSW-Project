    ...
    <div class="container mt-3 mb-3">
        <div class="card profile-card p-3">
            ...
            <div class="order-summary mb-4">
                <div class="summary-box">
                    ...
                    <div class="summary-row">
                        ...
                        <span class="subtotal">€ <fmt:formatNumber value="${subtotal}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                    </div>

                    <div class="summary-row total-row">
                        <span><strong>Totale:</strong></span>
                        <span class="item-total">€ <fmt:formatNumber value="${subtotal}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                    </div>
                </div>
            </div>
            ...
            <div class="order-info-section">
                    <div>
                        <p><strong>In consegna a <c:out value="${loggedInUser.firstName}"/> <c:out value="${loggedInUser.lastName}"/></strong></p>
                        <c:choose>
                            ...
                            <c:choose>
                                <c:when test="${not empty billingAddress}">
                                    <p>
                                        ...
                                        <c:out value="${billingAddress.postalCode}"/> <c:out value="${billingAddress.city}"/>,
                                ...
                                <c:if test="${not empty product}">
                                    <div class="product-item">
                                        ...
                                        <div class="product-total">
                                            <span class="item-total">€ <fmt:formatNumber value="${product.currentPrice * item.quantity}" type="number" minFractionDigits="2" maxFractionDigits="2"/></span>
                                        </div>
                                    </div>
                                </c:if>
                            </c:forEach>
