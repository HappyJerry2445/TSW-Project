...
<main class="container mt-3 mb-3">
    <div class="orders-page-container">
        ...
        <div class="order-info-section">
            <div class="row">
                <div>
                    ...
                    <p><strong>Totale:</strong> € <fmt:formatNumber value="${order.totalAmount}" type="number" minFractionDigits="2" maxFractionDigits="2"/></p>
                    <p><strong>Indirizzo di Spedizione:</strong>
                        <c:choose>
                            <c:when test="${not empty shippingAddress}">
                            <p><c:out value="${shippingAddress.postalCode}"/> <c:out value="${shippingAddress.city}"/>, <c:out value="${shippingAddress.country}"/></p>
                        </c:when>
                            <c:otherwise>
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p class="total-price">
                                            ...
                                            <span class="item-total">
                                                € <fmt:formatNumber value="${item.unitPrice * item.quantity}" type="number" minFractionDigits="2" maxFractionDigits="2"/>
                                            </span>
                                        </p>
                                    </div>
                                </div>
        ...
        <div class="text-center links mt-3">
            <a href="<c:url value='/common/orders'/>" class="btn btn-primary">Torna agli ordini</a>
        </div>
    </div>
</main>
